...
view model =
    let
        articles =
            List.filter (\article -> List.member model.selectedTag article.tags) -- Filters through list of tags if it has selected tag in it Need extra clarafication
                model.allArticles
...
viewTag selectedTagName tagName =
    ...
    button
        ...
        , onClick 
            ...
            , data = tagName -- I put text tagName
            }
        ]
        [ text tagName ]
